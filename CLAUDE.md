...
- **Combined Laravel + Supervisor frontend**: `script_domain_generate.sh` can generate Nginx configs that proxy `/` to a Supervisor-managed Node app while routing `/api`, `/sanctum`, `/storage`, `/broadcasting` to PHP-FPM.
